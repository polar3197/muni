...
I was inspired to see if I could map all public transportation vehicles in San Francisco in real-time. This project taught me about processing large volumes of data quickly and cost-effectively. Since then I have been adding simple but often overlooked features, like showing the path of a bus route 
